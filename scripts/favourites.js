...
for (let id of favList) {
    fetch('https://superheroapi.com/api.php/1166441817229936/' + id + '/image')
        .then(res => res.json())
...
function createCard(data, id) {
    ...
    detailsButton.innerHTML = 'Click Here To Know Me More......<i  class="fas fa-heart"></i>';
    ...
    favButton.innerHTML = '<i id="fav-icon" class="fas fa-star"></i>';
...
favCard.onclick = function (event) {
    ...
    if (favList.length === 0)
        favCard.innerHTML = '<div style="font-size:30px; margin: 10%; text-align: center; color: white;">Favourites List Empty.<div>'
}
